...
As explained in "Extra Manufacturer Data" document, Victron use the AES Counter mode (AES-CTR) protocol to encrypt the data. AES-CTR is a [Block Cipher Mode of Operation](https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation#CTR) that turns a block cipher into a stream cipher.
...
##### [BatteryMonitor.ino](./BatteryMonitor/BatteryMonitor.ino)
The main body, with `setup()` and `loop()` per the Arduino environment

##### [BatteryMonitor/VBM.h](./BatteryMonitor.VBM.h) / [VBM.cpp](./BatteryMonitor/VBM.cpp)
...
##### [BatteryMonitor/ZZ.h](./BatteryMonitor/ZZ.h) / [ZZ.cpp](./BatteryMonitor/ZZ.cpp)
...
##### [SolarController/VSC.h](./SolarController/VSC.h) / [VSC.cpp](./SolarController/VSC.cpp)
...
##### [SolarController/ZZ.h](./SolarController/ZZ.h) / [ZZ.cpp](./SolarController/ZZ.cpp)
This pair provide miscellaneous general/global variables or functions, simply to keep the main body clean.
